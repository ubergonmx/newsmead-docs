---
description: >-
  This article shows how to manage this documentation site and how to contribute
  to it.
---
...
The front matter is the metadata of the page and it is **always required**. It is written in YAML format and is enclosed in `---` at the top of the page. For example:
